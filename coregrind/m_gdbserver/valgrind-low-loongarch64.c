/* Low level interface to valgrind, for the remote server for GDB integrated
   ...
   It has been inspired from files from gdbserver in gdb 15.
                        ...
                        transfer_direction dir, int size, Bool* mod)
{
   ...
   *mod = False;
   ...
   case 76:  VG_(transfer) (&loongarch64->guest_X0,   buf, dir, size, mod); break;
   case 77:  VG_(transfer) (&loongarch64->guest_X1,   buf, dir, size, mod); break;
   case 78:  VG_(transfer) (&loongarch64->guest_X2,   buf, dir, size, mod); break;
   case 79:  VG_(transfer) (&loongarch64->guest_X3,   buf, dir, size, mod); break;
   case 80:  VG_(transfer) (&loongarch64->guest_X4,   buf, dir, size, mod); break;
   case 81:  VG_(transfer) (&loongarch64->guest_X5,   buf, dir, size, mod); break;
   case 82:  VG_(transfer) (&loongarch64->guest_X6,   buf, dir, size, mod); break;
   case 83:  VG_(transfer) (&loongarch64->guest_X7,   buf, dir, size, mod); break;
   case 84:  VG_(transfer) (&loongarch64->guest_X8,   buf, dir, size, mod); break;
   case 85:  VG_(transfer) (&loongarch64->guest_X9,   buf, dir, size, mod); break;
   case 86:  VG_(transfer) (&loongarch64->guest_X10,  buf, dir, size, mod); break;
   case 87:  VG_(transfer) (&loongarch64->guest_X11,  buf, dir, size, mod); break;
   case 88:  VG_(transfer) (&loongarch64->guest_X12,  buf, dir, size, mod); break;
   case 89:  VG_(transfer) (&loongarch64->guest_X13,  buf, dir, size, mod); break;
   case 90:  VG_(transfer) (&loongarch64->guest_X14,  buf, dir, size, mod); break;
   case 91:  VG_(transfer) (&loongarch64->guest_X15,  buf, dir, size, mod); break;
   case 92:  VG_(transfer) (&loongarch64->guest_X16,  buf, dir, size, mod); break;
   case 93:  VG_(transfer) (&loongarch64->guest_X17,  buf, dir, size, mod); break;
   case 94:  VG_(transfer) (&loongarch64->guest_X18,  buf, dir, size, mod); break;
   case 95:  VG_(transfer) (&loongarch64->guest_X19,  buf, dir, size, mod); break;
   case 96:  VG_(transfer) (&loongarch64->guest_X20,  buf, dir, size, mod); break;
   case 97:  VG_(transfer) (&loongarch64->guest_X21,  buf, dir, size, mod); break;
   case 98:  VG_(transfer) (&loongarch64->guest_X22,  buf, dir, size, mod); break;
   case 99:  VG_(transfer) (&loongarch64->guest_X23,  buf, dir, size, mod); break;
   case 100: VG_(transfer) (&loongarch64->guest_X24,  buf, dir, size, mod); break;
   case 101: VG_(transfer) (&loongarch64->guest_X25,  buf, dir, size, mod); break;
   case 102: VG_(transfer) (&loongarch64->guest_X26,  buf, dir, size, mod); break;
   case 103: VG_(transfer) (&loongarch64->guest_X27,  buf, dir, size, mod); break;
   case 104: VG_(transfer) (&loongarch64->guest_X28,  buf, dir, size, mod); break;
   case 105: VG_(transfer) (&loongarch64->guest_X29,  buf, dir, size, mod); break;
   case 106: VG_(transfer) (&loongarch64->guest_X30,  buf, dir, size, mod); break;
   case 107: VG_(transfer) (&loongarch64->guest_X31,  buf, dir, size, mod); break;
   case 108: VG_(transfer) (&loongarch64->guest_X0,   buf, dir, size, mod); break;
   case 109: VG_(transfer) (&loongarch64->guest_X1,   buf, dir, size, mod); break;
   case 110: VG_(transfer) (&loongarch64->guest_X2,   buf, dir, size, mod); break;
   case 111: VG_(transfer) (&loongarch64->guest_X3,   buf, dir, size, mod); break;
   case 112: VG_(transfer) (&loongarch64->guest_X4,   buf, dir, size, mod); break;
   case 113: VG_(transfer) (&loongarch64->guest_X5,   buf, dir, size, mod); break;
   case 114: VG_(transfer) (&loongarch64->guest_X6,   buf, dir, size, mod); break;
   case 115: VG_(transfer) (&loongarch64->guest_X7,   buf, dir, size, mod); break;
   case 116: VG_(transfer) (&loongarch64->guest_X8,   buf, dir, size, mod); break;
   case 117: VG_(transfer) (&loongarch64->guest_X9,   buf, dir, size, mod); break;
   case 118: VG_(transfer) (&loongarch64->guest_X10,  buf, dir, size, mod); break;
   case 119: VG_(transfer) (&loongarch64->guest_X11,  buf, dir, size, mod); break;
   case 120: VG_(transfer) (&loongarch64->guest_X12,  buf, dir, size, mod); break;
   case 121: VG_(transfer) (&loongarch64->guest_X13,  buf, dir, size, mod); break;
   case 122: VG_(transfer) (&loongarch64->guest_X14,  buf, dir, size, mod); break;
   case 123: VG_(transfer) (&loongarch64->guest_X15,  buf, dir, size, mod); break;
   case 124: VG_(transfer) (&loongarch64->guest_X16,  buf, dir, size, mod); break;
   case 125: VG_(transfer) (&loongarch64->guest_X17,  buf, dir, size, mod); break;
   case 126: VG_(transfer) (&loongarch64->guest_X18,  buf, dir, size, mod); break;
   case 127: VG_(transfer) (&loongarch64->guest_X19,  buf, dir, size, mod); break;
   case 128: VG_(transfer) (&loongarch64->guest_X20,  buf, dir, size, mod); break;
   case 129: VG_(transfer) (&loongarch64->guest_X21,  buf, dir, size, mod); break;
   case 130: VG_(transfer) (&loongarch64->guest_X22,  buf, dir, size, mod); break;
   case 131: VG_(transfer) (&loongarch64->guest_X23,  buf, dir, size, mod); break;
   case 132: VG_(transfer) (&loongarch64->guest_X24,  buf, dir, size, mod); break;
   case 133: VG_(transfer) (&loongarch64->guest_X25,  buf, dir, size, mod); break;
   case 134: VG_(transfer) (&loongarch64->guest_X26,  buf, dir, size, mod); break;
   case 135: VG_(transfer) (&loongarch64->guest_X27,  buf, dir, size, mod); break;
   case 136: VG_(transfer) (&loongarch64->guest_X28,  buf, dir, size, mod); break;
   case 137: VG_(transfer) (&loongarch64->guest_X29,  buf, dir, size, mod); break;
   case 138: VG_(transfer) (&loongarch64->guest_X30,  buf, dir, size, mod); break;
   case 139: VG_(transfer) (&loongarch64->guest_X31,  buf, dir, size, mod); break;
   case 140: *mod = False; break; // GDBTD?? src0
   case 141: *mod = False; break; // GDBTD?? src1
   case 142: *mod = False; break; // GDBTD?? src2
   case 143: *mod = False; break; // GDBTD?? src3
   case 144: *mod = False; break; // GDBTD?? eflags
   case 145: *mod = False; break; // GDBTD?? ftop
   default: vg_assert(0);
   }
}
